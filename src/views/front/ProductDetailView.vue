    ...
    <div class="flex flex-col mb-20">
      ...
      <article class="px-4 text-center">
        ...
        <div class="flex justify-center">
          <button type="button" class="px-2 py-1 rounded-s-md bg-fog-200 hover:bg-primary hover:text-dark" @click="tempQty -= 1"> - </button>
                  <button type="button" class="text-fog-400 px-4 py-1 bg-fog-200 border-x border-x-fog-300"> {{ tempQty }}</button>
                <button type="button" class="px-2 py-1 rounded-e-md bg-fog-200 hover:bg-primary hover:text-dark" @click="tempQty += 1"> + </button>
                <button type="button" class="bg-secondary py-2 px-4 rounded-md text-white ml-4 hover:bg-primary hover:text-dark"> 加入購物車 </button>
        </div>
      </article>
    </div>
  </div>
