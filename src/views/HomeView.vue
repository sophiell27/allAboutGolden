...
<template>
  <main>
    <!--  72 +  24   -->
    <section class="bg-[url('../assets/images/home/hero-bg-sm.svg')] bg-cover -mt-24 pb-[184px] mb-6">
        ...
        <ul class="grid grid-cols-12 gap-y-6">
          ...
          <li class="col-span-12">
            <a href="" class="block rounded-2xxl shadow-lg2 bg-white pt-4 pb-6 px-3">
              ...
              <p class="text-sm text-dark">對於藝術風iPhone 14 Pro手機殼給予高度評價。手機殼的設計非常獨特，充滿藝術感，而且質感也很好。此外，手機殼的保護性能也非常出色，可以有效保護手機不受損。</p>
            </a>
          </li>
          <li class="col-span-12">
            <a href="" class="block rounded-2xxl shadow-lg2 bg-white pt-4 pb-6 px-3">
              ...
              <p class="text-sm text-dark">油畫非常精美，色彩鮮豔，繪畫技巧精湛，能夠看出畫家花了很多時間和精力。這不僅僅是一件藝術品，更是一個擁有深刻意義的作品。雖然油畫沒有連框，但是絲毫不影響畫作的美感，非常滿意。</p>
            </a>
          </li>
          <li class="col-span-12">
            <a href="" class="block rounded-2xxl shadow-lg2 bg-white pt-4 pb-6 px-3">
